  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route
          path="/cart"
          element={<Carrinho carrinho={carrinho} setCarrinho={setCarrinho} frutas={frutas} setFrutas={setFrutas}/>}
        />
        <Route
          path="/cadastro"
          element={<Cadastro carrinho={carrinho} setCarrinho={setCarrinho} frutas={frutas} setFrutas={setFrutas}/>}
        />
      </Routes>
    </BrowserRouter>
  );
